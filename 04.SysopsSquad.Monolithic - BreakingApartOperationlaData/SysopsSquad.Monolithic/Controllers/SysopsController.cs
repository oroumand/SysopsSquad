...
namespace SysopsSquad.Monolithic.Controllers
{
    ...
    public class SysopsController : ControllerBase
    {
        ...
        private readonly ISupportContractService _supportContractService;
        ...
        public SysopsController(
            ...
            IBillingService billingService,
             IReportingService reportingService,
              ISupportContractService supportContractService)
        {
        ...
        public IActionResult CreateContract([FromBody] CreateContractRequest request)
        {
            try
            {
                var contract = _supportContractService.CreateContract(request.CustomerId, request.ProductName, request.EndDate);
                return Ok(contract);
            }
        ...
        {
            var details = _supportContractService.GetContractDetails(id);
    ...
    public record CreateContractRequest(int CustomerId, string ProductName, DateTime EndDate);
